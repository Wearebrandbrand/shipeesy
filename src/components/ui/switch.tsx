  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "data-[size=lg]:h-[32px] data-[size=lg]:w-[58px]",
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          "group-data-[size=lg]/switch:size-6 group-data-[size=lg]/switch:data-checked:translate-x-[calc(100%+4px)] group-data-[size=lg]/switch:data-unchecked:translate-x-[4px]",
        )}
      />
    </SwitchPrimitive.Root>
  )
